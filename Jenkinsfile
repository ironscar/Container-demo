                        ...
                        script {
                            switch(BRANCH_NAME) {
                                case 'snapshot': 
                                    ...
                                    sh 'ansible-playbook -i ${ansibleSnapshotDir}/inventory.yml --vault-id stage_vault@password-file ${ansiblePlaybookDir}/docker_playbook.yml --tags "spring-boot-docker,common"'
                                    break
                                case 'main':
                                    writeFile(file: 'password-file', text: ansibleProdVaultPass_PSW)
                                    sh 'ansible-playbook -i ${ansibleMainDir}/inventory.yml --vault-id prod_vault@password-file ${ansiblePlaybookDir}/docker_playbook.yml --tags "spring-boot-docker,common"'
                                    break
                                default: 
